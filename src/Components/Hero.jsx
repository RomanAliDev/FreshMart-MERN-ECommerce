  ...
  pt-32 md:pt-28 text-center md:text-left"
    >
      <div className="md:w-[60%] lg:w-1/2 text-white flex flex-col gap-7">
        ...
        <div>
          <button className="bg-white text-green-500 py-2 px-4 rounded-lg hover:border hover:text-white hover:bg-green-500 border-white font-semibold  cursor-pointer mr-5">
            Shop Now
          </button>
          <button className="bg-green-800 text-white py-2 px-4 rounded-lg  font-semibold  cursor-pointer hover:bg-green-700">
            Learn More
          </button>
        </div>
      </div>
